...
class SettingController extends CI_Controller
{
    ...
    public function add_setting()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $this->form_validation->set_rules('fb_url', 'Facebook url', 'required|valid_url');
            $this->form_validation->set_rules('x_url', 'X url', 'required|valid_url');
            $this->form_validation->set_rules('insta_url', 'Instagram url', 'required|valid_url');
            $this->form_validation->set_rules('yt_url', 'Youtube url', 'required|valid_url');
