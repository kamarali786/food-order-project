    ...
    <div class="row justify-content-center" style="margin-top: 140px;">
        <div class="col-md-5">
            <div class="card shadow p-4">
                ...
                <form id="auth-form" action="<?= base_url('register') ?>" method="post" onclick="register()">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="confrinPassword" class="form-label">Confirn Password</label>
                        <input type="password" class="form-control" id="confrinPassword" name="confrinPassword" placeholder="Enter Confrim password">
                    </div>
