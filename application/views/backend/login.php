<?php $this->load->view('backend/includes/links.php') ?>
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Sign in to continue to Food.</p>
                                    </div>
                                </div>
                                <div class="col-5 align-self-end">
                                    <img src="assets/backend/images/profile-img.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <div class="auth-logo">
                                <a href="index.html" class="auth-logo-light">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="assets/backend/images/logo-light.svg" alt="" class="rounded-circle" height="34">
                                        </span>
                                    </div>
                                </a>
                                ...
                                <a href="index.html" class="auth-logo-dark">
                                    <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light">
                                            <img src="assets/backend/images/logo.svg" alt="" class="rounded-circle" height="34">
                                        </span>
                                    </div>
                                </a>
                            </div>
                                ...
                                <form class="form-horizontal" action="<?php echo base_url("admin-login/login") ?>" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if ($this->session->flashdata('email')): ?>
                                            ...
                                            <span style="color: red;"><?php echo $this->session->flashdata('email'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if ($this->session->flashdata('password')): ?>
                                            <span style="color: red;"><?php echo $this->session->flashdata('password'); ?></span>
                                        <?php endif; ?>
