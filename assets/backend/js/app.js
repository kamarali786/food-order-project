	...
	function r(e) {
		1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
			? (s("html").removeAttr("dir"),
			  ...
			  s("#app-style").attr("href", "assets/backend/css/app.min.css"),
			...
			? (s("html").removeAttr("dir"),
			  ...
			  s("#bootstrap-style").attr(
					"href",
					"assets/backend/css/bootstrap-dark.min.css"
			  ),
			  s("#app-style").attr("href", "assets/backend/css/app-dark.min.css"),
			...
			? (s("#light-mode-switch").prop("checked", !1),
			  ...
			  s("#app-style").attr("href", "assets/backend/css/app-rtl.min.css"),
			  s("html").attr("dir", "rtl"),
			...
			: 1 == s("#dark-rtl-mode-switch").prop("checked") &&
			  ...
			  s("#bootstrap-style").attr(
					"href",
					"assets/backend/css/bootstrap-dark-rtl.min.css"
			  ),
			  s("#app-style").attr("href", "assets/backend/css/app-dark-rtl.min.css"),
			  s("html").attr("dir", "rtl"),
